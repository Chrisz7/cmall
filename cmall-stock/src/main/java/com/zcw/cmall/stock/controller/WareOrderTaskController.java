...
public class WareOrderTaskController {
     ...
     */
    @RequestMapping("/list")
    //@RequiresPermissions("stock:wareordertask:list")
    ...
    //@RequiresPermissions("stock:wareordertask:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("stock:wareordertask:save")
    ...
    //@RequiresPermissions("stock:wareordertask:update")
    ...
    //@RequiresPermissions("stock:wareordertask:delete")
